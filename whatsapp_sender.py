...
def send_messages(contact_name, message, num_times):
    ...
    user = driver.find_element(
        By.XPATH, "//*[contains(text(), '" + contact_name + "')]"
    )
    user.click()
